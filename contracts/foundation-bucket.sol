...
contract TokenFoundationBucket is Pausable,Ownable {
    ...
    constructor(TransferToken tokenAddress,uint256 epochtime)  {
    ...
    function ProcessClaim() external whenNotPaused {
        ...
        require(_erc20Token.transfer(_msgSender(), claimableBalance), "Token transfer failed!"); 
    }
